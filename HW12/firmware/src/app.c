    ...
    switch (appData.state) {
        ...
        case APP_STATE_MOUSE_EMULATE:
            if(_CP0_GET_COUNT() >CORE_TICKS){
                ...
                if (recondata[0]>0){
                    accelPercentX = (recondata[0])/163;
                    LCD_drawXProgress(120,160,1,BAR_LENGTH,accelPercentX,ILI9341_BLUE,ILI9341_WHITE);
                ...
                if (recondata[1]>0){
                    accelPercentY = (recondata[1])/163;
                    LCD_drawYProgress(120,160,1,BAR_LENGTH,accelPercentY,ILI9341_BLUE,ILI9341_WHITE);
            ...
            if(inc == 10){
                ...
                appData.xCoordinate = accelPercentX/10;
                appData.yCoordinate = accelPercentY/10;
                inc =0;
            }
            else{
