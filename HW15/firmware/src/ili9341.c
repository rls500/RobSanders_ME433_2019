...
void LCD_drawGraph(unsigned char array[]){
    int i;
    int scaledValue;
    for(i=0;i<240;i++){
        scaledValue = array[i]>>5;
        LCD_drawPixel(i,200-scaledValue,ILI9341_BLACK);
    }
}

void LCD_clearBox(int xStart, int xEnd, int yStart, int yEnd, unsigned short color){
    int i;
    int j;
